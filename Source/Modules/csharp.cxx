...
public:
  ...
  void emitProxyClassDefAndCPPCasts(Node *n) {
	...
	Printf(proxy_class_code, "    bool hasDerivedMethod = methodInfo.IsVirtual && !methodInfo.IsAbstract && methodInfo.DeclaringType.IsSubclassOf(typeof(%s)) && methodInfo.DeclaringType != methodInfo.GetBaseDefinition().DeclaringType;\n", proxy_class_name);
